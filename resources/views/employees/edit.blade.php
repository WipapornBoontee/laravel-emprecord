...
@section('title', 'แก้ไขข้อมูลพนักงาน - ' . $employee->name)
...
<style>
    ...
    .preview-header-banner {
        background: linear-gradient(135deg, rgba(245, 158, 11, 0.2) 0%, rgba(99, 102, 241, 0.15) 100%);
        height: 85px;
        position: relative;
        border-bottom: 1px solid var(--surface-border);
    }
...
<div class="row justify-content-center">
    <div class="col-12">
        ...
        <div class="breadcrumb-custom">
            ...
            <span class="separator"><i class="bi bi-chevron-right"></i></span>
            <a href="{{ route('employees.show', $employee, false) }}">{{ $employee->name }}</a>
            <span class="separator"><i class="bi bi-chevron-right"></i></span>
            <span class="active">แก้ไขข้อมูล</span>
        </div>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
                            <h3 class="fw-bold mb-0 gradient-text">แก้ไขข้อมูลพนักงาน</h3>
                            <span class="badge rounded-pill bg-body-tertiary text-theme border border-theme px-2 py-1 small">
                                <i class="bi bi-upc me-1"></i>{{ $employee->emp_code }}
                            </span>
                        </div>
                        <p class="text-muted mb-0 small">
                            กำลังแก้ไขข้อมูล: <strong>{{ $employee->name }}</strong> &bull; สิทธิ์ปัจจุบัน: <span class="text-primary fw-semibold">{{ ucfirst($employee->role) }}</span>
                        </p>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <a href="{{ route('employees.show', $employee, false) }}" class="btn btn-cancel-custom btn-sm d-inline-flex align-items-center gap-2">
                        <i class="bi bi-eye"></i>
                        <span>ดูโปรไฟล์</span>
                    </a>
        ...
        <form method="POST" action="{{ route('employees.update', $employee, false) }}" id="editEmployeeForm">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-icon-group">
                                        ...
                                        <input type="text" class="form-control-pro @error('emp_code') is-invalid @enderror" 
                                            id="emp_code" name="emp_code" value="{{ old('emp_code', $employee->emp_code) }}" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if(Auth::user()->isHr())
                                        <div class="form-text small text-warning mt-1">
                                            <i class="bi bi-info-circle me-1"></i>บัญชี HR ไม่สามารถยกระดับเป็น Admin ได้
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label for="password" class="form-label-pro">
                                        ...
                                        <span class="text-muted fw-normal small">(เว้นว่างไว้หากไม่เปลี่ยน)</span>
                                    </label>
                                    <div class="input-icon-group">
                                        <i class="bi bi-key input-icon-left"></i>
                                        <input type="password" class="form-control-pro @error('password') is-invalid @enderror" 
                                            id="password" name="password" placeholder="ระบุอย่างน้อย 6 ตัวอักษรเพื่อรีเซ็ต" autocomplete="new-password">
                        ...
                        <div class="form-section-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="no-pos-warning-edit" class="text-danger small mt-2 d-none">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center justify-content-between gap-3 pt-2 mb-5">
                        ...
                        <button type="submit" id="btn-submit-edit" class="btn btn-submit-custom d-inline-flex align-items-center justify-content-center gap-2">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="preview-card mb-4">
                        ...
                        <div class="p-4 text-center">
                            ...
                            <h5 class="fw-bold mb-1 text-theme text-truncate" id="previewName">{{ $employee->name }}</h5>
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-2 mb-3 flex-wrap">
                                ...
                                <span class="badge bg-primary-subtle text-primary border border-primary-subtle" id="previewRole">
                                    <i class="bi bi-shield-check me-1"></i> {{ ucfirst($employee->role) }}
                                </span>
                            </div>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div class="preview-info-tile d-flex align-items-center gap-2">
                                        ...
                                        <div class="small flex-grow-1 text-truncate">
                                            ...
                                            <span class="fw-semibold text-theme" id="previewDept">{{ $employee->department->name ?? 'ยังไม่ระบุ' }}</span>
                                        </div>
                                    </div>
                                    <div class="preview-info-tile d-flex align-items-center gap-2">
                                        ...
                                        <div class="small flex-grow-1 text-truncate">
                                            ...
                                            <span class="fw-semibold text-theme" id="previewPos">{{ $employee->position->name ?? 'ยังไม่ระบุ' }}</span>
                                        </div>
                                    </div>
                                    <div class="preview-info-tile d-flex align-items-center gap-2">
                                        ...
                                        <div class="small flex-grow-1 text-truncate">
                                            ...
                                            <span class="fw-semibold text-theme" id="previewEmail">{{ $employee->email }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tip-card mb-4">
                        <div class="d-flex align-items-center gap-2 mb-3">
                            ...
                            <h6 class="fw-bold mb-0 text-theme" style="font-size: 0.9rem;">ข้อมูลสำคัญ</h6>
                        </div>
                        <ul class="list-unstyled mb-0 d-flex flex-column gap-2 small text-muted">
                            <li class="d-flex align-items-start gap-2">
                                <i class="bi bi-check-circle-fill text-success mt-1"></i>
                                <span><strong>รหัสผ่าน:</strong> หากไม่ต้องการเปลี่ยนรหัสผ่านเดิม ให้ปล่อยช่องรหัสผ่านว่างไว้</span>
                            </li>
                            <li class="d-flex align-items-start gap-2">
                                <i class="bi bi-shield-check text-primary mt-1"></i>
                                <span><strong>สิทธิ์และแผนก:</strong> การเปลี่ยนแผนกหรือตำแหน่งจะมีผลต่อการยื่นขอลาและรายงานสถิติ</span>
                            </li>
                        </ul>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const warningDiv = document.getElementById('no-pos-warning-edit');
